  ...
  return (
    <div className="dark:text-white relative">
      <a
        ...
        className="inline-flex items-center px-2 md:px-3 py-1.5 text-sm font-medium text-black whitespace-nowrap bg-[#FFDD00] hover:bg-[#FFDD00]/90 rounded-lg transition-colors z-[9999] right-5 bottom-5 fixed"
      >
        <svg
      ...
      <section className="relative overflow-hidden min-h-screen pt-8">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
          ...
          >
            ...
            <motion.h1
              className="text-[40px] md:text-[65px] font-bold mb-6 text-gray-900 dark:text-white"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.2 }}
            >
              Turn Articles into <br />
              <span className="text-5xl md:text-7xl bg-gradient-to-r from-primary-600 to-primary-400 bg-clip-text text-transparent">
                Quick Insights
              </span>
            </motion.h1>
            <motion.p
              className="text-[15px] md:text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.4 }}
            >
              Instantly summarize any article, blog post, or document into
              concise, readable summaries. Save time and stay informed with
