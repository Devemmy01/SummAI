...
const ShareButtons = ({ url, summary }) => {
  const shareData = {
  ...
  return (
    <div className="flex gap-2 mt-4 w-full">
      ...
      <button
        ...
        className="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 pl-10 flex items-end justify-end w-full mr-5"
        title="Copy Summary"
      >
        <i className='bx bx-clipboard text-2xl text-primary-500'></i>
      </button>
    </div>
  );
};
